...
import com.parvez.service.ProductSalesService;
...
// data from db
                    ...
                    int nowAvailableQty = bs.getAvilableQty() - Integer.parseInt(txtQty.getText());
                    ProductSummary bsxyz = new ProductSummary(txtProductCode.getText(), Integer.parseInt(txtQty.getText()), Integer.parseInt(txtQty.getText()), nowAvailableQty, txtName.getText());
                    pss.save(bsxyz);
    ...
    public void displayProductDataWithinTable() {
        ProductSummaryService productService = new ProductSummaryService();
        List<ProductSummary> pList = productService.getList();
